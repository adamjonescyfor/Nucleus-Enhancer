...
(function () {
    ...
    function toText(html) {
        ...
        // A newline BEFORE each line break / block element, so adjacent blocks — and a
        // bare first line followed by a <p> — don't run together. e.g. "test<p>test2</p>"
        // → "test\ntest2", not "testtest2".
        doc.body.querySelectorAll('br, p, li, div, tr, h1, h2, h3, h4, h5, h6, blockquote').forEach(function (el) {
